...
insert into Customer values('Lamia', 1914321, '11AM-7PM', '17-MAR-2022', 'Hotel Sea View');
insert into Customer values('Priota', 1716821, '9AM-6PM', '19-MAR-2022', 'Rojonigondha');
insert into Customer values('Samia', 1814251, '8AM-3PM', '27-APR-2022', 'Grand Sultan');
...
insert into Booking values (1814251,101);
insert into Booking values (1914321,102);
insert into Booking values (5678942,104);
insert into Booking values (1914321,101);
insert into Booking values (1814251,104);
insert into Booking values (1716821,104);
...
--select * from Vehicle union
--select * from Vehicle1@site1;
